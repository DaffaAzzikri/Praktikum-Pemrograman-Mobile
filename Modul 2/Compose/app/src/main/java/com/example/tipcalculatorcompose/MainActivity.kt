...
fun TipTimeLayout() {
    ...
    val tipPercent = selectedTipText.removeSuffix("%").toDoubleOrNull() ?: 15.0
    ...
    Column(
        ...
        TipDropdownMenu(
            options = tipOptions,
            selectedOptionText = selectedTipText,
            expanded = expanded,
            onExpandedChange = { expanded = it },
            onOptionSelected = { selectedTipText = it },
...
fun TipDropdownMenu(
    ...
    ExposedDropdownMenuBox(
        ...
        TextField(
            ...
            leadingIcon = { Icon(painter = painterResource(id = R.drawable.ic_percent), null) },
